                ...
                <div class="list-group">
                    @foreach($categories as $cat)
                        @if($cat->id === $category->id)
                            <a href="{{action('CategoryController@show', ['id' => $cat->id])}}" class="list-group-item currentCat">{{$cat->name}}</a>
                        @else
                            <a href="{{action('CategoryController@show', ['id' => $cat->id])}}" class="list-group-item">{{$cat->name}}</a>
                        @endif
                    @endforeach
                </div>
